...
import { CreateEventRequest, CreateTicketRequest, VoucherObject, CreateVoucherRequest, TransactionObject, CreateTransactionRequest, UpdateTransactionRequest } from '../../entities/entities';
...
export class EventController {
  ...
  async GetEvents(req: Request, res: Response): Promise<void> {
    try {
      ...
      const events = await this.eventsRepo.GetEvents(startDateFilter, categoryFilter);
